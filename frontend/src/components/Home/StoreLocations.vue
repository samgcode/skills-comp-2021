<template>
    <body>
        ...
        <select v-model="cityName" class="text-xl rounded-md bg-primary p-2 my-2" data-aos="fade-up">
            ...
            <option class="dropdown-item">Fort McMurray</option>
        </select>
        <p data-aos="fade-up">{{ cityInfo }}</p>    
    </body>        
</template>
        ...
        mapURL() {
            ...
            switch(this.cityName) {
                case 'Calgary':
                    ...
                    this.cityInfo = 'Our downtown Calgary office is located on the Bow River, steps away from restaurants, shops & the downtown core.'
                    break
                case 'Edmonton':
                    ...
                    this.cityInfo = 'Located near the river valley, our office is steps from the parliament buildings & downtown core.'
                    break
                case 'Lethbridge':
                ...
                case 'Fort McMurray':
                    ...
                    this.cityInfo = 'Our Fort McMurray office is right downtown.'
                    break
            }
            this.forceMapRender()
            return url
