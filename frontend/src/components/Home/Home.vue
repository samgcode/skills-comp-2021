    ...
    <body>
        <div class="xl:mx-52 lg:mx-40 md:mx-32 sm:mx-10">
            <div class="px-8 py-4">
                ...
                <h2 class="text-3xl text-gray-500 underline">A better way to breath</h2>
                <div class="mt-6">
        ...
        <div class="full-width-container bg-blue-superdark">
            <h1 class="text-3xl text-white underline pt-6">We are committed to delivering the best air possible.</h1>
        ...
        <div class="full-width-container pt-32">
            <h1 class="text-2xl underline">Where do we get our air?</h1>
            ...
            <div class="md:grid-cols-2 mt-12 container grid grid-cols-1 max-w-6xl xl:mx-52 lg:mx-40 md:mx-32 sm:mx-10 mx-3 gap-4">
                <div class="text-left max-w-md">
                    <h2 class="text-blue">Banf Air</h2>
                    <p class="py-3">
                ...
                <div class="text-left max-w-md">
                    <h2 class="text-blue">Lake Louise Air</h2>
                    <p class="py-3">
